...
8. **CLUSTERED INDEX** (кластерный индекс)
   ...
   - Данные таблицы физически упорядочены по PRIMARY KEY.
...
13. CLUSTERED INDEX - как он работает и для чего он нужен?
    - Кластерный индекс упорядочивает строки таблицы в физической памяти по ключу.
      - Это ускоряет запросы, использующие PRIMARY KEY или кластерный индекс.
      - Это упрощает поиск данных, связанных с ключом.
