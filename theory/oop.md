...
переопределить методы родительского класса в дочернем классе, изменив их логику. Этот принцип не накладывает строгих 
ограничений на то, как поведение изменяемого метода должно быть реализовано.
